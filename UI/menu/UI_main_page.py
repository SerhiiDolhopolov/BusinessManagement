...
def get_available_button() -> str:
    return __buttons.get('available').format(emoji=StatusManager.get_emoji(StatusType.AVAILABLE))

def get_phones_button() -> str:
    return __buttons.get('phones')

def get_need_spares_button() -> str:
    return __buttons.get('need_spares').format(emoji=StatusManager.get_emoji(StatusType.WAITING_FOR_SPARES))

def get_need_repairs_button() -> str:
    return __buttons.get('need_repairs').format(emoji=StatusManager.get_emoji(StatusType.WAITING_FOR_REPAIRS))
